...
public class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
	...
	public var outterView: UIView = UIView()
    ...
    */
    public init(sourceView: UIView, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffectStyle = .Light) {
		...
		outterView = UIView(frame: CGRectMake(0, 0,
			sourceView.frame.width,
			sourceView.frame.height))
		outterView.backgroundColor = UIColor.blackColor()
		outterView.layer.opacity = 0.3;
...
*/
    ...
    */
    ...
    private func toggleMenu (shouldOpen: Bool) {
		...
		self.outterView.hidden = !shouldOpen
